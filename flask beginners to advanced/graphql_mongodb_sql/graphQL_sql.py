...
app.config['MYSQL_DB'] ='grapgql_sql'
...
#sudo su
#mysql -u root -p;
#CREATE DATABASE graphql_sql;
#use grapgql_sql;
#SHOW DATABASES;
#SHOW TABLES;
#DESCRIBE todoapp;
#CREATE TABLE todoapp(id INT(11) AUTO_INCREMENT PRIMARY KEY, title VARCHAR(100), description VARCHAR(30), done BOOLEAN());
#DESCRIBE todoapp;
#SHOW DATABESE